...
This section provides a small introduction on how to use Jupyter Notebooks. If you're already at ease with Jupyter, you can xref:2-04-object-detection.adoc[head to the next section].
